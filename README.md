...
git clone https://github.com/https://github.com/zain211/zaintyh.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf zain211 && rm -rf .telegram-cli && git clone https://github.com/mustafaflux/superflux-bot.git && cd zain211&& ./launch.sh install && ./launch.sh
~~~~~
